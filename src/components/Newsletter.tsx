  ...
  return (
    <section id="contact" className="py-20 bg-sage-700">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionTitle
          title="בואי נשארת בקשר"
          subtitle="בחרי את הדרך המתאימה לך לקבל תוכן, כלים והשראה"
          light
        />
        ...
        <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 text-white">
            ...
            <h3 className="text-2xl font-bold mb-3">בריאות בפשטות</h3>
            <p className="text-warm-200 mb-6 leading-relaxed">
              קבוצת וואטסאפ שקטה בה תקבלי אחת לשבוע כלים פשוטים, נגישים ופרקטיים
              גם לאישה עסוקה - כדי להבריא את חייך ואת ביתך.
            </p>

            <ul className="space-y-2 mb-6 text-warm-200">
              <li className="flex items-center gap-2">
                <Check size={16} className="text-sage-300" />
                <span>תוכן פעם בשבוע</span>
              </li>
              <li className="flex items-center gap-2">
                <Check size={16} className="text-sage-300" />
                <span>כלים פשוטים ופרקטיים</span>
              </li>
              <li className="flex items-center gap-2">
                <Check size={16} className="text-sage-300" />
                <span>ללא ספאם</span>
          ...
          <div className="bg-white rounded-3xl p-8">
            ...
            <h3 className="text-2xl font-bold text-sage-800 mb-3">מכתב ממני</h3>
            <p className="text-gray-600 mb-6 leading-relaxed">
              לנשים שאוהבות להעמיק, להבין את המעבר והמאחורה של הדברים.
              מוזמנת לצרף מייל ולהתחיל לקבל ממני מסרים מעמיקים.
            </p>
